...
const Navbar = () => {
  ...
  const linkClasses = "relative after:absolute after:bg-stone-700 after:bottom-0 after:left-0 after:h-[2px] after:w-full after:translate-y-1 after:opacity-0 hover:after:translate-y-0 hover:after:opacity-100 after:transition after:ease-in-out after:duration-200";
  return (
    <header className="fixed top-0 left-0 right-0  backdrop-blur-sm z-30">
      <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
        {/* Logo Placeholder */}
        <div className="text-2xl font-bold text-gray-800">
          <a href="#hero">YourLogo</a>
        </div>
