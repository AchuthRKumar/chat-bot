                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="col-span-1">
                        ...
                        <div className="mt-6 flex space-x-4">
                            <a href="https://x.com/achuth_rk" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter-x" viewBox="0 0 16 16">
